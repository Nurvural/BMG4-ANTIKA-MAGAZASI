            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                                    ...
                                    <div class="card card-navy">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="sergi_isim" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputDescription">Açıklama</label>
                                                <textarea required name="aciklama" class="form-control" rows="4"></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="firma_sahip" class="form-control">
                                            </div>
                                    ...
                                    <div class="card card-pink">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="number" name="butce" p class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label>Başlama Tarihi:</label>
                                                <div class="input-group">
                                                    <input required type="date" class="form-control float-right" name="baslama_tarih">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input required type="time" class="form-control float-right" name="saat">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input required type="file" class="custom-file-input" name="dosya">
                    ...
                    if (isset($_POST['olustur'])) {
                        ...
                        mysqli_query($conn, "INSERT INTO sergi (sergi_ismi, aciklama, icerik, firma, sahip, butce, bas_tarih, bit_tarih, saat, resim_isim, resim) VALUES ('$sergi_ad', '$sergi_aciklama', '$sergi_icerik', '$sergi_firma', '$sergi_sahip', '$sergi_butce', '$sergi_basla_tarih', '$sergi_bitis_tarih', '$sergi_saat', '$resim_isim', '$resim_boyutu')");

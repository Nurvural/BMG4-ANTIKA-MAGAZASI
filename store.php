                ...
                <section class="content">
                    <div class="card card-solid">
                        <div class="card-body pb-0">
                            ...
                            $tablo = mysqli_query($conn, "select * from magaza");
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                        <div class="card bg-light">
                                            <div class="card-header text-muted border-bottom-0">
                                                <?php echo $dizi["magazaismi"]; ?>
                                            </div>
                                            <form method="POST">
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        <div class="col-7">
                                                            <h2 class="lead"><b><?php echo $name = $dizi["magazaismi"]; ?></b></h2>
                                                            <p class="text-muted text-sm"><b>Hakkında: </b> Slogan vs.. </p>
                                                            <ul class="ml-4 mb-0 fa-ul text-muted">
                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Adres <?php echo $dizi["adres"]; ?></li>
                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Telefon <?php echo $dizi["telefon"]; ?></li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="card-footer">
                                                    <div class="text-right">
                                                        <a href="shop.php" class="btn btn-sm btn-primary">

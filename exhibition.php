                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        <div class="col-7">
                                                            ...
                                                            <p class="text-muted text-sm"><b>Hakkında: </b></p>
                                                            <ul class="ml-4 mb-0 fa-ul text-muted">
                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> <b> Adres : </b> <?php echo $dizi["firma"]; ?></li>
                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg"></i></span> <b> Bütçe : </b><?php echo $dizi["butce"]; ?></li>
                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg"></i></span> <b> Başlama Tarihi : </b> <?php echo $dizi["bas_tarih"]; ?></li>
                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg"></i></span> <b> Bitiş Tarih : </b> <?php echo $dizi["bit_tarih"]; ?></li>
